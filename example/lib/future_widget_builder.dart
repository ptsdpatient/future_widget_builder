...
class FutureWidgetBuilder extends StatefulWidget {
  ...
  @override
  State<FutureWidgetBuilder> createState() => _MethodBuilder();
}

class _MethodBuilder extends State<FutureWidgetBuilder> {
  bool visible = true;
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: widget.gridCols ?? 1,
              mainAxisSpacing: widget.gap ?? 5,
              crossAxisSpacing: widget.gap ?? 5,
              childAspectRatio: widget.gridRows ?? 2,
            ),
