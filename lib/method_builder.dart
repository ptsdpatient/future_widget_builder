                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(
                                children: [
                                  widget.mediaPreviewBuilder?.call(item) ??
                                      SnapImageView(
                                        imageUrls: widget.productPreviewBuilder?.call(item) ?? [
                          ...
                          widget.productDescriptionBuilder?.call(item) ??
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    item.length > 1 ? item[1] : "Irusu Play VR Ultra 3D VR Headset-Virtual Reality Headset with HD Lens,Controller,Stereo Headphones 3.5mm Jack to Type C ",
                                    maxLines: 2,
                                    style: TextStyle(
                                      fontSize: 16,
